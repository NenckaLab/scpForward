...
set_target_properties(ofstd PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "/usr/lib/libiconv.dylib;/usr/lib/libcharset.dylib;pthread"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libofstd.3.6.3.dylib"
  IMPORTED_SONAME_RELEASE "libofstd.13.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS ofstd )
list(APPEND _IMPORT_CHECK_FILES_FOR_ofstd "${_IMPORT_PREFIX}/lib/libofstd.3.6.3.dylib" )
...
set_target_properties(oflog PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/liboflog.3.6.3.dylib"
  IMPORTED_SONAME_RELEASE "liboflog.13.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS oflog )
list(APPEND _IMPORT_CHECK_FILES_FOR_oflog "${_IMPORT_PREFIX}/lib/liboflog.3.6.3.dylib" )
...
set_target_properties(dcmdata PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libdcmdata.3.6.3.dylib"
  IMPORTED_SONAME_RELEASE "libdcmdata.13.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS dcmdata )
list(APPEND _IMPORT_CHECK_FILES_FOR_dcmdata "${_IMPORT_PREFIX}/lib/libdcmdata.3.6.3.dylib" )
...
set_target_properties(i2d PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libi2d.3.6.3.dylib"
  IMPORTED_SONAME_RELEASE "libi2d.13.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS i2d )
list(APPEND _IMPORT_CHECK_FILES_FOR_i2d "${_IMPORT_PREFIX}/lib/libi2d.3.6.3.dylib" )
...
set_target_properties(dcmimgle PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libdcmimgle.3.6.3.dylib"
  IMPORTED_SONAME_RELEASE "libdcmimgle.13.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS dcmimgle )
list(APPEND _IMPORT_CHECK_FILES_FOR_dcmimgle "${_IMPORT_PREFIX}/lib/libdcmimgle.3.6.3.dylib" )
...
set_target_properties(dcmimage PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "oflog;dcmdata;dcmimgle;/opt/local/lib/libtiff.dylib;/opt/local/lib/libjpeg.dylib;/opt/local/lib/libpng.dylib"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libdcmimage.3.6.3.dylib"
  IMPORTED_SONAME_RELEASE "libdcmimage.13.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS dcmimage )
list(APPEND _IMPORT_CHECK_FILES_FOR_dcmimage "${_IMPORT_PREFIX}/lib/libdcmimage.3.6.3.dylib" )
...
set_target_properties(dcmjpeg PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libdcmjpeg.3.6.3.dylib"
  IMPORTED_SONAME_RELEASE "libdcmjpeg.13.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS dcmjpeg )
list(APPEND _IMPORT_CHECK_FILES_FOR_dcmjpeg "${_IMPORT_PREFIX}/lib/libdcmjpeg.3.6.3.dylib" )
...
set_target_properties(ijg8 PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libijg8.3.6.3.dylib"
  IMPORTED_SONAME_RELEASE "libijg8.13.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS ijg8 )
list(APPEND _IMPORT_CHECK_FILES_FOR_ijg8 "${_IMPORT_PREFIX}/lib/libijg8.3.6.3.dylib" )
...
set_target_properties(ijg12 PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libijg12.3.6.3.dylib"
  IMPORTED_SONAME_RELEASE "libijg12.13.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS ijg12 )
list(APPEND _IMPORT_CHECK_FILES_FOR_ijg12 "${_IMPORT_PREFIX}/lib/libijg12.3.6.3.dylib" )
...
set_target_properties(ijg16 PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libijg16.3.6.3.dylib"
  IMPORTED_SONAME_RELEASE "libijg16.13.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS ijg16 )
list(APPEND _IMPORT_CHECK_FILES_FOR_ijg16 "${_IMPORT_PREFIX}/lib/libijg16.3.6.3.dylib" )
...
set_target_properties(dcmjpls PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libdcmjpls.3.6.3.dylib"
  IMPORTED_SONAME_RELEASE "libdcmjpls.13.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS dcmjpls )
list(APPEND _IMPORT_CHECK_FILES_FOR_dcmjpls "${_IMPORT_PREFIX}/lib/libdcmjpls.3.6.3.dylib" )
...
set_target_properties(charls PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libcharls.3.6.3.dylib"
  IMPORTED_SONAME_RELEASE "libcharls.13.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS charls )
list(APPEND _IMPORT_CHECK_FILES_FOR_charls "${_IMPORT_PREFIX}/lib/libcharls.3.6.3.dylib" )
...
set_target_properties(dcmtls PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "ofstd;dcmdata;dcmnet;/opt/local/lib/libssl.dylib;/opt/local/lib/libcrypto.dylib"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libdcmtls.3.6.3.dylib"
  IMPORTED_SONAME_RELEASE "libdcmtls.13.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS dcmtls )
list(APPEND _IMPORT_CHECK_FILES_FOR_dcmtls "${_IMPORT_PREFIX}/lib/libdcmtls.3.6.3.dylib" )
...
set_target_properties(dcmnet PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "ofstd;oflog;dcmdata;/opt/local/lib/libwrap.dylib"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libdcmnet.3.6.3.dylib"
  IMPORTED_SONAME_RELEASE "libdcmnet.13.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS dcmnet )
list(APPEND _IMPORT_CHECK_FILES_FOR_dcmnet "${_IMPORT_PREFIX}/lib/libdcmnet.3.6.3.dylib" )
...
set_target_properties(dcmsr PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "ofstd;oflog;dcmdata;dcmimgle;dcmimage;/opt/local/lib/libxml2.dylib"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libdcmsr.3.6.3.dylib"
  IMPORTED_SONAME_RELEASE "libdcmsr.13.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS dcmsr )
list(APPEND _IMPORT_CHECK_FILES_FOR_dcmsr "${_IMPORT_PREFIX}/lib/libdcmsr.3.6.3.dylib" )
...
set_target_properties(cmr PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libcmr.3.6.3.dylib"
  IMPORTED_SONAME_RELEASE "libcmr.13.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS cmr )
list(APPEND _IMPORT_CHECK_FILES_FOR_cmr "${_IMPORT_PREFIX}/lib/libcmr.3.6.3.dylib" )
...
set_target_properties(dcmdsig PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "ofstd;dcmdata;/opt/local/lib/libssl.dylib;/opt/local/lib/libcrypto.dylib"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libdcmdsig.3.6.3.dylib"
  IMPORTED_SONAME_RELEASE "libdcmdsig.13.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS dcmdsig )
list(APPEND _IMPORT_CHECK_FILES_FOR_dcmdsig "${_IMPORT_PREFIX}/lib/libdcmdsig.3.6.3.dylib" )
...
set_target_properties(dcmwlm PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libdcmwlm.3.6.3.dylib"
  IMPORTED_SONAME_RELEASE "libdcmwlm.13.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS dcmwlm )
list(APPEND _IMPORT_CHECK_FILES_FOR_dcmwlm "${_IMPORT_PREFIX}/lib/libdcmwlm.3.6.3.dylib" )
...
set_target_properties(dcmqrdb PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "ofstd;dcmdata;dcmnet"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libdcmqrdb.3.6.3.dylib"
  IMPORTED_SONAME_RELEASE "libdcmqrdb.13.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS dcmqrdb )
list(APPEND _IMPORT_CHECK_FILES_FOR_dcmqrdb "${_IMPORT_PREFIX}/lib/libdcmqrdb.3.6.3.dylib" )
...
set_target_properties(dcmpstat PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libdcmpstat.3.6.3.dylib"
  IMPORTED_SONAME_RELEASE "libdcmpstat.13.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS dcmpstat )
list(APPEND _IMPORT_CHECK_FILES_FOR_dcmpstat "${_IMPORT_PREFIX}/lib/libdcmpstat.3.6.3.dylib" )
...
set_target_properties(dcmrt PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libdcmrt.3.6.3.dylib"
  IMPORTED_SONAME_RELEASE "libdcmrt.13.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS dcmrt )
list(APPEND _IMPORT_CHECK_FILES_FOR_dcmrt "${_IMPORT_PREFIX}/lib/libdcmrt.3.6.3.dylib" )
...
set_target_properties(dcmiod PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libdcmiod.3.6.3.dylib"
  IMPORTED_SONAME_RELEASE "libdcmiod.13.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS dcmiod )
list(APPEND _IMPORT_CHECK_FILES_FOR_dcmiod "${_IMPORT_PREFIX}/lib/libdcmiod.3.6.3.dylib" )
...
set_target_properties(dcmfg PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libdcmfg.3.6.3.dylib"
  IMPORTED_SONAME_RELEASE "libdcmfg.13.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS dcmfg )
list(APPEND _IMPORT_CHECK_FILES_FOR_dcmfg "${_IMPORT_PREFIX}/lib/libdcmfg.3.6.3.dylib" )
...
set_target_properties(dcmseg PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libdcmseg.3.6.3.dylib"
  IMPORTED_SONAME_RELEASE "libdcmseg.13.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS dcmseg )
list(APPEND _IMPORT_CHECK_FILES_FOR_dcmseg "${_IMPORT_PREFIX}/lib/libdcmseg.3.6.3.dylib" )
...
set_target_properties(dcmtract PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "dcmiod;dcmdata;ofstd;oflog"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libdcmtract.3.6.3.dylib"
  IMPORTED_SONAME_RELEASE "libdcmtract.13.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS dcmtract )
list(APPEND _IMPORT_CHECK_FILES_FOR_dcmtract "${_IMPORT_PREFIX}/lib/libdcmtract.3.6.3.dylib" )
...
set_target_properties(dcmpmap PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "dcmfg;dcmiod;dcmdata;ofstd;oflog"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libdcmpmap.3.6.3.dylib"
  IMPORTED_SONAME_RELEASE "libdcmpmap.13.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS dcmpmap )
list(APPEND _IMPORT_CHECK_FILES_FOR_dcmpmap "${_IMPORT_PREFIX}/lib/libdcmpmap.3.6.3.dylib" )
